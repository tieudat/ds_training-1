            ...
            <div class="dashboard">
                        ...
                        <ul class="left__menu">
                            ...
                            <li class="left__menuItem">
                                ...
                                <div class="left__text">
                                    ...
                                    <a class="left__link" href="#">Tất Cả Danh Mục</a>
                                </div>
                            </li>
                            <li class="left__menuItem">
                ...
                <div class="right">
                    <div class="right__content">
                        ...
                        {foreach from=$edit_news item=item}
                        <form action="?mod=home&site=edit_news&id={$item.id}" method="post">{/foreach}
                            
                            {foreach from=$edit_news item= a}
                                <div class="right__formWrapper">
                                            ...
                                            <div class="right__formTitle">
                                                    <div class="right__formTitle-content">
                                                        <div class="right__inputWrapper">
                                                            ...
                                                            <input type="text" name="title" value="{$a.title}" placeholder="Thêm tiêu đề">
                                                        </div>
                                                        <div class="right__inputWrapper">
                                                            <label>Alias</label>
                                                        ...
                                                        <div class="right__inputWrapper">
                                                            ...
                                                            <textarea rows="4" name="description" value="">{$a.description}</textarea>
                                                        </div>              
                                                    </div>
                                            </div>      
                                                        ...
                                                        <div class="right__inputWrapper-abc">
                                                            {foreach from=$taxonomy_name item=i }
                                                                <label for="checkbox"><input type="checkbox" value="{$i.id}" name="checkbox" id="checkbox">{$i.name}
                                                                    <input type="hidden" value="{$i.id}" name="{$i.name}">
                                                                </label>
                                                            {/foreach}
                                                        </div>         
                                                    </div>
                                    ...
                                    <div class="right__formBigTag">
                                            <div class="right__formTag">
                                                <div class="right__formTag-content">
                                                    <div class="right__inputWrapper">
                                                        <label>Từ Khóa</label>
                                                        <input type="text" name="keyword" value="{$a.keyword}" placeholder="">
                                                    </div>
                                                    <div class="right__inputWrapper">
                                    ...
                                    <div class="right__formEditor">
                                        <div class="right__formEditor-content">
                                            <div class="right__inputWrapper">
                                                <textarea class="ckeditor" value="" name="content">{$a.content}</textarea>
                                            </div>   
                                        </div>
                                    </div>
                                    ...
                                    <div class="right__formSubmit">
                                        <button type="submit" class="btn-success" onclick="notify()" name="sub_bai"><i class="fa fa-check fa-fw"></i>Cập nhật</button>

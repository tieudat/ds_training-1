            ...
            <div class="dashboard">
                ...
                <div class="right">
                    <div class="right__content">
                        ...
                        <p class="right__desc">Danh sách bài viết</p>
                        <div class="right__table">
                            <div class="right__tableWrapper">
                                <table>
                                    ...
                                    <tbody>
                                        {foreach from =$id_post item=i }
                                            <tr>
                                                <td>{$i.id}</td>
                                                <td>{$i.title}</td>
                                                <td>{$i.keyword}</td>
                                                <td value ="{$i.taxonomy_id}">{$i.taxonomy_id}</td>
                                                <td><a href="?mod=home&site=edit_news&id={$i.id}" >Sửa</a></td>
                                                <td><a href="?mod=home&site=delete_new&id={$i.id}">Xóa</a></td>
                                            </tr>
                                        {/foreach}
                                    </tbody>
                                </table>
